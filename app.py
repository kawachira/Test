...
# --- 3. ส่วนหัวข้อ ---
st.markdown("<h1>💎 Ai<br><span style='font-size: 1.5rem; opacity: 0.7;'>ระบบวิเคราะห์หุ้นอัจฉริยะ (MTF Fixed: EMA 200)</span></h1>", unsafe_allow_html=True)
...
def get_data_hybrid(symbol, interval, mtf_interval):
    try:
        ...
        # ✅ MTF ดึง 10 ปีเสมอ เพื่อให้ EMA 200 Week คำนวณได้ชัวร์
...
if submit_btn:
    ...
    if df is not None and not df.empty and len(df) > 10: 
        ...
        if df_mtf is not None and not df_mtf.empty:
            # ✅ FIX: ใช้ EMA 200 แทน EMA 50 สำหรับ Multi-Frame
