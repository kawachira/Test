...
with col_form:
    with st.form(key='search_form'):
        ...
        with c2:
            ...
            # ตั้งค่า Timeframe หลัก และ Timeframe ใหญ่ (MTF)
...
# ✅ Smart Logic: ฟังก์ชันอธิบายแบบมนุษย์ (ไม่ขัดแย้งกัน)
...
# --- 7. AI Decision Engine (Logic 3.0: แก้บั๊ก HIMS + คำแนะนำ Holder) ---
def ai_hybrid_analysis(price, ema20, ema50, ema200, rsi, macd_val, macd_sig, adx, bb_up, bb_low, 
    ...
    # แยกถังเก็บข้อมูล: ปัจจัยบวก vs ปัจจัยลบ
    bullish_factors = [] 
    bearish_factors = []
